...
try:
    eigen_centrality = nx.eigenvector_centrality(subgraph_simple, max_iter=1000)
except nx.PowerIterationFailedConvergence:
    eigen_centrality = nx.eigenvector_centrality(subgraph_simple, max_iter=5000)

# Get top 5 nodes
top_5_nodes = sorted(eigen_centrality, key=eigen_centrality.get, reverse=True)[:5]
...
plt.title('Top 5 Eigenvector Centrality Nodes (Use Mouse to Pan/Zoom)')
plt.show()